 ...
 * RecyclerView列表间隔线
 */
public class BookContentsListDecoration extends RecyclerView.ItemDecoration {

    private Drawable mDrawable;

    public BookContentsListDecoration(Context context) {
        mDrawable = context.getResources().getDrawable(R.drawable.item_book_contents_list_decoration);
    }
